  ...
  return (
    <>
      ...
      <div className="container_section--mission_Cont">
        <section class="container_section container_section--mission">
          <div class="row">
            <h2 class="container_section_title container_section_title--underlined container_section_title--small">
              Миссия компании
            </h2>
      ...
      <section class="container_section">
        <div class="row">
          ...
          <div class="container_widgets container_widgets--grid">
            <div class="container_widgets_item">
              <h3
                class="container_widgets_item_title"
      ...
      </section><section id="team" class="container_section">
      <div class="row tac">
        <h2>Слаженная команда</h2>
        <p class="hugetext">В разработке проекта участвуют специалисты своего дела, благодаря чему мы можем предложить вам отличный продукт!</p>
      </div>
      <div class="row">
        <div class="team" id="teamMembers">
          <div class="team_member">
            ...
            <div class="team_member_info">
              <div class="team_member_name">Артём Маслов</div>
              <div class="team_member_job">Генеральный директор</div>
              <div class="team_member_desc">Помогаю клиентам направить вектор коллективного намерения в правильную сторону</div>
            </div>
          </div>
          ...
          <div class="team_member">
            ...
            <div class="team_member_info">
              <div class="team_member_name">Владислав Мёдов</div>
              <div class="team_member_job">Технический директор</div>
              <div class="team_member_desc">Координирую разработку продукта и поддерживаю работу технических процессов компании</div>
            </div>
          </div>
          ...
          <div class="team_member">
            ...
            <div class="team_member_info">
              <div class="team_member_name">Максим Перов</div>
              <div class="team_member_job">Коммерческий директор</div>
              <div class="team_member_desc">Подбираю клиентам и партнерам лучшее предложение для решения их бизнес-задач</div>
            </div>
          </div>
          ...
          <div class="team_member">
            ...
            <div class="team_member_info">
              <div class="team_member_name">Андрей Титовский</div>
              <div class="team_member_job">Дизайнер продукта</div>
              <div class="team_member_desc">Создаю внешний облик продукта, его юзабилити, учитываю нюансы, делаю его — отличным</div>
            </div>
          </div>
          ...
          <div class="team_member">
            ...
            <div class="team_member_info">
              <div class="team_member_name">Анастасия Маслова</div>
              <div class="team_member_job">Руководитель клиентского сервиса</div>
              <div class="team_member_desc">Забочусь о счастье и комфорте наших клиентов! Помогаю решать бизнес-задачи с помощью обучения на платформе</div>
            </div>
          </div>
        </div>
